...
export type SampleMetadataWhere = {
  ...
  investigatorSampleId_NOT_IN?: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
...
export type RecentDeliveriesQueryVariables = Exact<{
  options?: InputMaybe<RequestOptions>;
  where?: InputMaybe<RequestWhere>;
...
export type RecentDeliveriesQuery = { __typename?: 'Query', requestsConnection: { __typename?: 'RequestsConnection', totalCount: number }, requests: Array<{ __typename?: 'Request', igoRequestId: string, igoProjectId: string, genePanel: string, dataAnalystName: string, dataAnalystEmail: string, dataAccessEmails: string, bicAnalysis: boolean, investigatorEmail: string, investigatorName: string, isCmoRequest: boolean, labHeadEmail: string, labHeadName: string, libraryType?: string | null, otherContactEmails: string, piEmail: string, projectManagerName: string, qcAccessEmails: string, smileRequestId: string }> };
...
export type RequestWithSamplesQuery = { __typename?: 'Query', requests: Array<{ __typename?: 'Request', igoRequestId: string, igoProjectId: string, genePanel: string, dataAnalystName: string, dataAnalystEmail: string, dataAccessEmails: string, bicAnalysis: boolean, investigatorEmail: string, investigatorName: string, isCmoRequest: boolean, labHeadEmail: string, labHeadName: string, libraryType?: string | null, otherContactEmails: string, piEmail: string, projectManagerName: string, qcAccessEmails: string, smileRequestId: string, hasSampleSamples: Array<{ __typename?: 'Sample', smileSampleId: string, sampleCategory: string, sampleClass: string, datasource: string, hasMetadataSampleMetadata: Array<{ __typename?: 'SampleMetadata', cmoSampleName?: string | null, igoComplete?: boolean | null, importDate: string, investigatorSampleId?: string | null, primaryId: string, sampleClass: string, cmoPatientId?: string | null, cmoSampleIdFields: string, sampleName?: string | null, preservation?: string | null, tumorOrNormal: string, oncotreeCode?: string | null, collectionYear: string, sampleOrigin?: string | null, tissueLocation?: string | null, sex: string }>, patientsHasSample: Array<{ __typename?: 'Patient', smilePatientId: string, patientAliasesIsAlias: Array<{ __typename?: 'PatientAlias', namespace: string, value?: string | null }> }> }> }> };

export type RequestPartsFragment = { __typename?: 'Request', igoRequestId: string, igoProjectId: string, genePanel: string, dataAnalystName: string, dataAnalystEmail: string, dataAccessEmails: string, bicAnalysis: boolean, investigatorEmail: string, investigatorName: string, isCmoRequest: boolean, labHeadEmail: string, labHeadName: string, libraryType?: string | null, otherContactEmails: string, piEmail: string, projectManagerName: string, qcAccessEmails: string, smileRequestId: string };
...
export type SamplesQuery = { __typename?: 'Query', samplesConnection: { __typename?: 'SamplesConnection', totalCount: number }, samples: Array<{ __typename?: 'Sample', smileSampleId: string }> };
...
export const RequestPartsFragmentDoc = gql`
  ...
  smileRequestId
    ...
    `;
export const RecentDeliveriesDocument = gql`
    query RecentDeliveries($options: RequestOptions, $where: RequestWhere, $requestsConnectionWhere2: RequestWhere) {
...
/**
 * __useRecentDeliveriesQuery__
 *
 * To run a query within a React component, call `useRecentDeliveriesQuery` and pass it any options that fit your needs.
 * When your component renders, `useRecentDeliveriesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRecentDeliveriesQuery({
 *   variables: {
 ...
 * });
 */
export function useRecentDeliveriesQuery(baseOptions?: Apollo.QueryHookOptions<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>(RecentDeliveriesDocument, options);
      }
export function useRecentDeliveriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>(RecentDeliveriesDocument, options);
        }
export type RecentDeliveriesQueryHookResult = ReturnType<typeof useRecentDeliveriesQuery>;
export type RecentDeliveriesLazyQueryHookResult = ReturnType<typeof useRecentDeliveriesLazyQuery>;
export type RecentDeliveriesQueryResult = Apollo.QueryResult<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>;
 ...
 * });
 */
export function useRequestWithSamplesQuery(baseOptions?: Apollo.QueryHookOptions<RequestWithSamplesQuery, RequestWithSamplesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RequestWithSamplesQuery, RequestWithSamplesQueryVariables>(RequestWithSamplesDocument, options);
      }
export function useRequestWithSamplesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RequestWithSamplesQuery, RequestWithSamplesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RequestWithSamplesQuery, RequestWithSamplesQueryVariables>(RequestWithSamplesDocument, options);
        }
export type RequestWithSamplesQueryHookResult = ReturnType<typeof useRequestWithSamplesQuery>;
export type RequestWithSamplesLazyQueryHookResult = ReturnType<typeof useRequestWithSamplesLazyQuery>;
export type RequestWithSamplesQueryResult = Apollo.QueryResult<RequestWithSamplesQuery, RequestWithSamplesQueryVariables>;
 ...
 * });
 */
export function useSamplesQuery(baseOptions?: Apollo.QueryHookOptions<SamplesQuery, SamplesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SamplesQuery, SamplesQueryVariables>(SamplesDocument, options);
      }
export function useSamplesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SamplesQuery, SamplesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SamplesQuery, SamplesQueryVariables>(SamplesDocument, options);
        }
...
export type SamplesQueryResult = Apollo.QueryResult<SamplesQuery, SamplesQueryVariables>;