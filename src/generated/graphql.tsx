...
export type RecentDeliveriesQuery = {
  __typename?: "Query";
 ...
 * });
 */
export function useRecentDeliveriesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    RecentDeliveriesQuery,
    RecentDeliveriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<RecentDeliveriesQuery, RecentDeliveriesQueryVariables>(
    RecentDeliveriesDocument,
    options
  );
}
export function useRecentDeliveriesLazyQuery(
  ...
  return Apollo.useLazyQuery<
    RecentDeliveriesQuery,
    RecentDeliveriesQueryVariables
  >(RecentDeliveriesDocument, options);
}
export type RecentDeliveriesQueryHookResult = ReturnType<
  typeof useRecentDeliveriesQuery
>;
export type RecentDeliveriesLazyQueryHookResult = ReturnType<
  typeof useRecentDeliveriesLazyQuery
>;
export type RecentDeliveriesQueryResult = Apollo.QueryResult<
  RecentDeliveriesQuery,
  RecentDeliveriesQueryVariables
>;
